...
const svgSource = await readFile(resolve(publicDir, 'icon-map.svg'), 'utf8');
...
// mask to render as black. The browser-tab SVG keeps the rounded corners.
const targets = [
  { file: 'apple-touch-icon-map.png', size: 180, square: true },
  { file: 'icon-map-192.png', size: 192, square: true },
  { file: 'icon-map-512.png', size: 512, square: true },
];
