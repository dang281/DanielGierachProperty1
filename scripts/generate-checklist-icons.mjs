...
const svgSource = await readFile(resolve(publicDir, 'icon-checklist.svg'), 'utf8');

const targets = [
  { file: 'apple-touch-icon-checklist.png', size: 180 },
  { file: 'icon-checklist-192.png', size: 192 },
  { file: 'icon-checklist-512.png', size: 512 },
];
